...
| 7 | #23 | 2025-07-15 | fix: add Image role for TalkBack on ImageView elements | `49868ff1` | pending | [#30](https://github.com/hggzm/Teams-AdaptiveCards-Mobile/pull/30) | ~~#509 (closed)~~ — pending re-creation |
| 8 | #24 | 2025-07-15 | fix: prevent TalkBack from announcing both Link and Button for OpenUrl | `c68a8b2a` | pending | [#31](https://github.com/hggzm/Teams-AdaptiveCards-Mobile/pull/31) | ~~#510 (closed)~~ — pending re-creation |
| 9 | #25 | 2025-07-15 | fix: announce error messages to TalkBack on validation failure | `d2275edc` | pending | [#32](https://github.com/hggzm/Teams-AdaptiveCards-Mobile/pull/32) | ~~#511 (closed)~~ — pending re-creation |
| 10 | #26 | 2025-07-15 | fix: correct TalkBack dropdown item count to exclude hidden placeholder | `90947278` | pending | [#33](https://github.com/hggzm/Teams-AdaptiveCards-Mobile/pull/33) | ~~#516 (closed)~~ — pending re-creation |
| 11 | #27 | 2025-07-15 | fix: prevent RadioGroup from aggregating child labels for TalkBack | `bd7eae63` | pending | [#34](https://github.com/hggzm/Teams-AdaptiveCards-Mobile/pull/34) | ~~#513 (closed)~~ — pending re-creation |
| 12 | #28 | 2025-07-15 | fix: ShowCard toggle announces expanded/collapsed instead of selected | `027675eb` | pending | [#35](https://github.com/hggzm/Teams-AdaptiveCards-Mobile/pull/35) | ~~#514 (closed)~~ — pending re-creation |
| 13 | #29 | 2025-07-15 | fix: render ProgressBar with accessible role and value info for TalkBack | `e338d0ef` | pending | [#36](https://github.com/hggzm/Teams-AdaptiveCards-Mobile/pull/36) | ~~#517 (closed)~~ — pending re-creation |

 ...
 * On Windows MSVC, ssize_t is not part of the C standard library. Several
 * public headers (notably git2/sys/stream.h) use ssize_t in callback
 * signatures. Provide it here so any public header that includes common.h
 * sees a valid typedef. <BaseTsd.h> defines SSIZE_T (uppercase).
 */
